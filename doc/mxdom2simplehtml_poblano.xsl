...
<xsl:template name="header">
    <div class="background">
      <a href="index.html"><img area="13494" src="images/logo.gif" alt="Sandia National Laboratories" border="0" height="78" width="173"></img></a>
    </div>
</xsl:template>
...
<xsl:template name="footer">
    <p class="footer">
      ...
      Copyright 2019, National Technology &amp; Engineering Solutions of Sandia, LLC (NTESS).<br/>
    </p>
</xsl:template>
